...
def generate_circle_container_thumbnail(width: int = 200, height: int = 150) -> pygame.Surface:
    ...
    import random
    random.seed(42)  # Consistent thumbnail
...
def generate_projectile_thumbnail(width: int = 200, height: int = 150) -> pygame.Surface:
